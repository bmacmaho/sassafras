...
But are they really giant towers, or are they windmills trying to scare us?`,
    footnotes: [
      "Miguel de Cervantes, *Don Quixote*, trans. Samuel Putman (New York: Viking Press, 1949), chap. 8.",
    ],
...
I recently came across the notion of 'iliggocene' - the age of 'dizziness' proposed as part of an exhibition project at Kindl Berlin.[^1] The name describes a new orientation towards our time, one that is blurry, hard to grasp, full of confluence and vertigo. There has been an effort to find a name of our time for a while now, with a few 'cenes (Anthropocene, Capitalocene, Cthulucene, Noocene, etc.) having made their rounds as potential representatives of a new social geology.[^2] I'm caught by the idea of an age of dizziness, though, not just as a name but as a state. It carries the suggestion that we live in a time of disorientation; perhaps because the systems we rely on are spinning ever more out of control, or because we seem to be teetering at a precipice of ever-cascading ecological damage. When I think of dizziness however, I mainly think of height and the disequilibrium that comes from the thought of 'how far down?'.

This writing frames itself around the question of height, and how height behaves as a critical tool in the ways we orient our social world. In his book *Animal Fables after Darwin*, Chris Danta describes how western humanist traditions have commonly envisioned their relationship to the world through vertical metaphors, as 'higher animals' whose moral and intellectual plane exists 'above' that of other creatures.[^3] Some of this is quite literal in terms of physical orientation -- animals walk on all fours and angle themselves towards the earth, whereas humans walk 'erect' and are physically oriented skywards. Plato was an early proponent of this idea, describing the posture of 'man' as indicative of 'his' rational physicality, where the brain/head (the seat of knowledge) is positioned at the 'acropolis' of the body, towering over the more lowly and 'bestial' organs and thereby less driven by bodily instinct than other creatures.[^4] We quickly see then that this disposition upwards is not just a physical distinction between 'man' and 'animal', but it is explicitly linked to moral predetermination in Western theological traditions. Ovid, in his first book 'Metamorphoses', describes 'the Creator' as having designed man to stand erect so that he may look towards the heavens and stars.[^5] Much the same is said by John Donne (1624), who describes humans as "naturally built and disposed to the contemplation of heaven".[^6] Danta highlights this further by bringing our attention to the story of the Babylonian King Nebuchadnezzar, who is punished by God for his boasting and made to live 'as an animal', walking on all fours and eating grass for seven years.[^7] It was only when he was able once more to turn his gaze upwards that his sanity was restored, and he could again revere and glorify God 'Most High'.[^8] Indeed, the consistent reference of height and posture to the divine sustains the idea that uprightness, straightness, and the vertical is itself the physical embodiment of ethical capacity. Not only is 'man' vertical, but there is the idea that man must *strive* for the vertical, that there is a social imperative to be the 'upright' citizen, to be 'righteous', and to embody a moral 'rectitude'.

This idea is further embodied in the historical drawing of social, natural, and moral hierarchies across intellectual traditions. Among the most famous examples of this is the work by Aristotle in his *History of Animals*, where he presents the notion of ordering all animals according to a grand scale or 'ladder' in terms of "complexity, perfection, and value".[^9] Inorganic and 'less complex' organisms exist at the bottom of this scale, above which we find plants, then 'lower animals' such as invertebrates, until we begin to reach 'higher' animals, with humans at the top of the animal scale (after which we enter the realm of gods). What makes this scale so consequential, as Lori Marino notes, is that it not only determines the interrelations of living matter, but also their worth and proximity to 'perfection'.[^10] Much like the erect posture of man, value is approximated to height or being at the 'top', which in turn measures one's capacity for 'goodness'. This is made even more acute by the fact that this system is one that rejects mobility, as Aristotle believed that every being's place on this 'Scala Naturae' (or natural scale), was materially and eternally fixed by universal forces. Perfection could therefore be framed as a single universal and upwards truth, while remaining ultimately unattainable by earthly forms.

This notion of the natural ordering of life has continued to emerge in various traditions and organisational methods across time.[^11] Take for example the *Rhetorica Christiana* written and illustrated by Didacus Valades in 1579. Prominently featured is 'The Great Chain of Being', a copperplate engraving which depicts at the very top a representation of God surrounded by a halo of light and angels, with what appears to be a young man (perhaps the figure of Jesus) on his lap. From the hand of God runs a chain, which passes then downwards over the page through layers of earthly beings. The first sees a collection of humans, then birds, then aquatic life, then mammals, then plants, minerals, and finally at the bottom of the page, we see Hell, filled with imagery of flames and torture.[^12] Once more there is a ladder of being, but this time the consequences of 'lowness' become dire. Here we find a blending of Aristotle's ordering of nature with the literal expression of perfection in the God 'on high', and lowness as being associated with true evil. Interestingly humans, like in the work of Aristotle, occupy the top of the chain just before the divine, privileged by their proximity to perfection but unable to actually attain it. Different from the Scala Naturae, however, is the presence of Hell in the image, which, given its Christian context, suggests that one's place on the scale (as human) is more mobile than previously suggested, and that perfection or punishment awaits according to the virtues of one's soul.
...
The imperative to move upwards in search of progress, immortality, perfection, or even just in pursuit of the 'good' or 'divine', is a dizzying thing. Indeed, in many ways, height seems to become a kind of material evidence for spiritual and moral significance, whether through our posture, in ladders of being, or in our towers. We see in many ways how the themes of height interlace throughout Western cosmological histories, into the divine right of kings, into separation of 'man' and 'animal', and so on. Neoliberal governance which bases itself closely on the notion of eternal growth and progress can in part be understood through this obsession with the 'higher' and with perfection. It is as though we are building our own metaphysical tower, ever further. I would argue that if our age is indeed one of dizziness, that it comes from this continuous effort to build higher faster stronger, in such a way that the stress of innovation (in AI, in agriculture, in mining, the infinite stock market, capitalist growth) fails to understand that no tower builds forever, and that at the heights of our fanaticism for height itself, the dizziness of the space we inhabit makes us blind to what is below, what we can longer see.`,
    footnotes: [
      ...
      "The term ''cenes' here refers to the names we give to geological era's. For example humans are considered to have evolved in an era lasting around 11,700 called the 'Holocene', before which the earth existed in a period called the Pleistocene, then Pliocene, and so on. These era's are characterized by climate, soil makeup, atmosphere, and other geological factors that affect how ecological cycles take form on our planet. Given the mounting evidence for human-caused climate change, there have been proposals seeking to recognise that we are entering a new geological age (the Anthropocene being among the first and most influential of these proposals). Some new and interdisciplinary projects/researchers have sought to foreground the socio-political implications in the naming of geological time, challenging both Holocene and Anthropocene in favor of more culturally grounded and critical names. For further reading see: T.J. Demos, Against the Anthropocene: Visual Culture and Environment Today (Berlin: Sternberg Press, 2017), or Heather M Davis and Etienne Turpin, Art in the Anthropocene: Encounters among Aesthetics, Politics, Environments and Epistemologies (London: Open Humanities Press, 2015).",
      "Chris Danta, *Animal Fables after Darwin* (Cambridge University Press, 2018), 4-7.",
      "Sander L Gilman, \"How Posture Makes Us Human,\" Nautil.us (Nautilus, April 27, 2018), https://nautil.us/how-posture-makes-us-human-237068.",
      "Metamorphoses, trans. Mary M. Innes (London: Penguin, 2003), 31.",
      "John Donne, *Devotions upon Emergent Occasions* (Ann Arbor, MI: University of Michigan Press, 1959), 17.",
      "Danta, *Animal Fables after Darwin*, 5.",
      "Dan. 4:30-4, New International Version.",
      "Lori Marino, \"Classification,\" in *Encyclopedia of Human-Animal Relationships: A Global Exploration of Our Connections with Animals* (Westport, Conn.: Greenwood Press, 2007), 220.",
      "Marino, \"Classification,\" 220-25.",
      "See: Marion Leathers Kuntz and Paul Grimley Kuntz, *Jacob's Ladder and the Tree of Life* (Peter Lang Incorporated, International Academic Publishers, 1987).",
      ...
      "George Lakoff and Mark Johnson, Metaphors We Live By (Chicago, IL: University of Chicago Press, 2003), 14.",
      ...
      "Oksana Maslovskaya and Grigoriy Ignatov, \"Conceptions of Height and Verticality in the History of Skyscrapers and Skylines,\" ed. D. Safarik, Y. Tabunschikov, and V. Murgul, *E3S Web of Conferences*, no. 33 (2018): 01005, https://doi.org/10.1051/e3sconf/20183301005.",
      "Gen. 11:1-9 (New International Version).",
      "Thomas A. P. Van Leeuwen, *The Skyward Trend of Thought* (MIT Press, 1990).",
      "Joseph J Korom, *American Skyscraper, 1850-1940: A Celebration of Height* (Boston: Branden, 2016).",
    ],
    bibliography: [
...
… that house scented with guava and Maud trying to reduce the vast quantity of fruit you kept harvesting. That week she made guava jelly, guava cheese, guava paste, stewed guava, and blended the pulp into drink. But your tree would not stop producing. It bore faster than she could cook or we could consume.[^1]
...
However, Tobagonians are resourceful with liminality. Many landowners in Tobago allow the branches of their fruit trees to grow over the boundaries of their property (usually fences). The fruit that hangs over the fence is culturally understood as available for picking, challenging the logic of enclosure and culture of individualism that the Law seeks to instill. Instead of the law eradicating a longstanding and cherished communal practice and lived experience, the practice evolves to preserve the values on which they are based. Your neighbour is your family, and there is always enough to share. This subversion ultimately highlights a vulnerability of the Law: this construct towering over the village derives its power from the community's consent.`,
    footnotes: [
      "Olive Senior, *Gardening in the Tropics* (Toronto: Insomniac Press, 2005).",
      "Trinidad and Tobago, \"Summary Offences Act,\" Chapter 11:02 § (1921).",
      ...
      "Trinidad and Tobago, \"Summary Offences Act,\" Chapter 11:02 § (1921).",
      "Karen McCullah Lutz and Kirsten Smith, \"Legally Blonde,\" Movie, *Metro-Goldwyn-Mayer*, 2001.",
    ],
    aspectRatio: 936 / 981,
...
While I am concerned about the larger systems of surveillance brought forth by the technocratic overlords, I worry more about the policing and surveillance that has been normalised and that I embody myself. Even if I were ever to escape these gazes, will I ever escape my own?`,
    footnotes: [
      "*Mole* is a term of endearment for young women or girls in Malayalam.",
      "Read more: Saumya Kalia, \"Indian Culture Normalizes Spying. This Affects How We View Digital Privacy,\" The Swaddle, August 14, 2021, https://www.theswaddle.com/spying-culture-digital-privacy.",
      "The Panopticon was first introduced by Jeremy Bentham as a design for prisons that made it possible for a central watchtower to survey prisoners at all times. The concept was later popularised by Michel Foucault in *Discipline and Punish* (1975) as a metaphor for the modern disciplinary society where one is watched at all times.",
    ],
...
These conditions are not simply the unfortunate side effects of technical advancements. The tech elite is already planning on exploiting access to intelligence, making one wonder to what extent these developments are intentional. Last year, the CEO of OpenAI, Sam Altman[^11], stated at a public event:
...
Taking into account all of these developments, it appears as if a new tower is being constructed. One in which the tech elite is guarding human intelligence, while the majority of people are stuck in a polluted environment shaped by social media and AI, diminishing critical thinking and engagement with social and political issues. Intelligence is becoming commodified, and access to it, as well as what it means and looks like, depends on a small tech elite, while many people are actively losing their economic bargaining power due to being replaced by AI. In this dystopian future, critical thinking and engagement with social sciences, philosophy, and humanities, which are the tools necessary to question and resist these developments, are reserved for the rich and privileged who can afford it. The rest forms the new underclass looking up at the tower.`,
    footnotes: [
      "@yagirldjmagic, \"the chronically online will be the new underclass,\" YouTube, https://www.youtube.com/watch?v=Bm2Q9HkbLsQ&list=WL&index=11&t=595s.",
      "\"Post-truth,\" Cambridge Dictionary, https://dictionary.cambridge.org/dictionary/english/post-truth.",
      "Philippa Hardman, \"The Impact of Gen AI on Human Learning,\" https://drphilippahardman.substack.com/p/the-impact-of-gen-ai-on-human-learning.",
      "On the MIT study on AI use and learning, https://time.com/7295195/ai-chatgpt-google-learning-school/.",
      "On the Nvidia CEO's comments, https://www.theguardian.com/technology/2026/jun/11/ai-absolutism-apocalyptic-future.",
      "https://www.theguardian.com/technology/2026/jun/11/ai-absolutism-apocalyptic-future.",
      "https://www.activedigital.co.uk/why-steve-jobs-ipad-childrens-screentime/.",
      "https://www.bbc.com/news/articles/c747x7gz249o.",
      "https://open.spotify.com/episode/0zrPQJBDLRQSCIa9NvJEXr?si=db500db69bbc4e97.",
      "\"The Humanities as a Compass: Navigating a Post-Truth Era,\" JSTOR, https://about.jstor.org/blog/the-humanities-as-a-compass-navigating-a-post-truth-era/.",
      "https://www.reddit.com/r/singularity/comments/1rro8ej/sam_altman_we_see_a_future_where_intelligence_is/.",
      "https://open.spotify.com/episode/0jtRs0yqVtrhvuzp3nEd7c?si=eca03105a6724103.",
