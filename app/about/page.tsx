...
export default function AboutPage() {
  ...
  return (
    <div className="relative pt-9 min-h-screen bg-[#fcfaf2] text-[#222] selection:bg-[#f0f0f0] font-sans overflow-x-hidden -mx-6 sm:-mx-12 md:-mx-16 lg:-mx-24 xl:-mx-32">
        ...
        <div className="w-1/2 border-2 border-black">
          {peopleData.map((person, i) => (
            <div key={person.id} className={i > 0 && openId !== peopleData[i - 1].id ? "border-t-2 border-black" : ""}>
              <button
                className={`w-full relative flex items-center pl-4 pr-2 py-2 text-left transition-colors duration-200 ${openId === person.id ? "bg-[#f0efe7]" : "hover:bg-[#f0efe7]"}`}
