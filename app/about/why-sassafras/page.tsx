...
function LeafDivider({ dm }: { dm: boolean }) {
  return (
    <div className="flex justify-center my-2">
      <Image src="/Little leaves.png" alt="" width={160} height={80} className={`object-contain brightness-0 ${dm ? "invert" : ""}`} />
    </div>
  )
}
...
export default function WhySassafrasPage() {
  ...
  return (
    <div className={`pt-9 min-h-screen font-sans overflow-x-hidden -mx-6 sm:-mx-12 md:-mx-16 lg:-mx-24 xl:-mx-32 transition-colors duration-300 ${dm ? "bg-black text-white" : "bg-[#fcfaf2] text-[#222]"}`}>
