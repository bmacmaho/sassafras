...
export default function HomePage() {
  return (
    <div className="w-[100vw] relative left-[calc(-50vw+50%)] -mb-32 md:-mb-56 bg-[#1a1a1a] text-[#FBFAF1] overflow-x-hidden font-sans">
      <ScrollAnimator />
      {/* ── First Page ── */}
      <section className="relative w-full h-screen bg-[#b9cdef] flex flex-col items-center justify-center overflow-hidden">
        <div className="absolute top-10 flex items-center justify-center gap-2 text-[#FBFAF1] text-xs tracking-widest uppercase">
        ...
        <div className="relative w-[85vw] md:w-[40vw] max-w-[450px] aspect-[3/4] border-[8px] md:border-[12px] border-[#FBFAF1] overflow-hidden shadow-2xl">
          <video 
            src="/IMG_4255.MOV" 
            autoPlay 
            muted 
      ...
      <section className="relative w-full min-h-screen bg-[#1a1a1a] overflow-hidden">
        <div className="relative w-full h-full max-w-[1920px] mx-auto pt-[1px]">
          ...
          <div className="absolute top-8 left-6 md:left-12 z-20 flex flex-col items-start">
            <h2 className="text-[#FBFAF1] text-3xl md:text-5xl tracking-wide uppercase">
              WELCOME TO SASSAFRAS
            </h2>
            <div className="flex flex-col gap-6 mt-8 text-[#FBFAF1] ml-2">
          ...
          <div className="absolute inset-0 z-0 pointer-events-none opacity-80">
            <svg width="100%" height="100%" preserveAspectRatio="xMidYMid slice" viewBox="0 0 1000 1000">
              ...
              <path d="M -100 500 C 300 400, 300 700, 500 500 S 700 200, 1100 400" fill="transparent" stroke="#FBFAF1" strokeWidth="0.5" opacity="0.5" />
              <path d="M 200 800 C 400 100, 600 400, 500 600 S 200 800, 400 1100" fill="transparent" stroke="#FBFAF1" strokeWidth="0.5" opacity="0.5" />
              <path d="M 700 100 C 900 -100, 1100 300, 900 500 S 600 700, 800 900" fill="transparent" stroke="#FBFAF1" strokeWidth="0.5" opacity="0.5" />

              {/* Path for text: Long vertical wave strictly in the center to avoid photos entirely */}
              <path id="curved-text-path" d="M 500 -200 Q 350 500 500 1200" fill="transparent" />
              
              <text className="text-[#FBFAF1] font-sans text-base md:text-lg font-light tracking-widest" fill="#FBFAF1" textAnchor="middle">
                <textPath id="animated-text-path" href="#curved-text-path" startOffset="50%">
          ...
          <div className="relative z-10 w-full h-[1500px] md:h-[1300px] mt-12 md:mt-16">
            
            {/* --- LEFT COLUMN --- */}
            
            {/* 1. CURRENT ISSUE */}
            <div className="absolute left-[20%] md:left-[22%] top-[5%] md:top-[5%] scroll-animate-item col-left opacity-0">
              <Link href="/current-issue" className="group flex flex-col items-start gap-2 transform -rotate-2 hover:rotate-0 transition-all duration-300">
                <div className="w-[70vw] md:w-[350px] aspect-[1.8/1] bg-[#FBFAF1] border-2 border-[#FBFAF1] shadow-lg overflow-hidden relative">
                ...
                <p className="text-[#FBFAF1] text-[10px] md:text-xs tracking-widest uppercase group-hover:underline">
            ...
            {/* 2. ALL ISSUES */}
            <div className="absolute left-[15%] md:left-[18%] top-[25%] md:top-[28%] scroll-animate-item col-left opacity-0">
            ...
            {/* 3. EXPLORE */}
            <div className="absolute left-[8%] md:left-[10%] top-[50%] md:top-[52%] scroll-animate-item col-left opacity-0">
              <Link href="/explore" className="group flex flex-col items-start gap-2 transform -rotate-1 hover:rotate-0 transition-all duration-300">
                <div className="w-[50vw] md:w-[220px] aspect-square bg-[#FBFAF1] border-2 border-[#FBFAF1] shadow-lg overflow-hidden relative">
            ...
            {/* 4. ABOUT US */}
            <div className="absolute right-[15%] md:right-[15%] top-[12%] md:top-[15%] scroll-animate-item col-right opacity-0">
              <Link href="/about" className="group flex flex-col items-start gap-2 transform rotate-3 hover:rotate-0 transition-all duration-300">
                <div className="w-[40vw] md:w-[220px] aspect-square bg-[#FBFAF1] border-[6px] md:border-[10px] border-[#e95e0e] shadow-2xl overflow-hidden p-2">
            ...
            <div className="absolute right-[10%] md:right-[12%] top-[35%] md:top-[40%] scroll-animate-item col-right opacity-0">
              <Link href="/submissions" className="group flex flex-col items-start gap-2 transform -rotate-2 hover:rotate-0 transition-all duration-300">
                <div className="w-[45vw] md:w-[250px] aspect-[4/3] bg-transparent border border-[#FBFAF1] shadow-2xl overflow-hidden p-2 hover:border-[#FBFAF1]/50 transition-colors duration-300">
                   <div className="w-full h-full border border-[#FBFAF1] flex items-center justify-center overflow-hidden">
            ...
            {/* 6. CONTACT/SUPPORT */}
            <div className="absolute right-[8%] md:right-[10%] top-[60%] md:top-[65%] scroll-animate-item col-right opacity-0">
              <Link href="/keep-in-touch" className="group flex flex-col items-start gap-2 transform rotate-2 hover:rotate-0 transition-all duration-300">
                <div className="w-[50vw] md:w-[280px] aspect-[1.6/1] bg-[#FBFAF1] border-2 border-[#FBFAF1]/80 shadow-xl overflow-hidden p-1 hover:border-[#FBFAF1] transition-colors duration-300">
